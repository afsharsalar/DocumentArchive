        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_Street = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    Address_City = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentCommentIds", x => new { x.DocumentId, x.Id });
                    table.ForeignKey(
                        name: "FK_DocumentCommentIds_Documents_DocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tags", x => new { x.DocumentId, x.Id });
                    table.ForeignKey(
